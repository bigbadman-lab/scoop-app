/**
 * Viem-compatible Pons LaunchAndBuy write ABI (Gate 2 verified shape).
 * Mirrors @scoop/contracts ponsV2LaunchAndBuyAbi — kept local for `as const` typing.
 */
export const ponsLaunchAndBuyWriteAbi = [
  {
    type: 'function',
    name: 'launchAndBuy',
...
export const ponsFactoryReadAbi = [
  {
    type: 'function',
    name: 'canLaunch',
...
export const ponsTokenLaunchedEventAbi = [
  {
    type: 'event',
    name: 'TokenLaunched',
    inputs: [
...
export const ponsCurveBuyEventAbi = [
  {
    type: 'event',
    name: 'CurveBuy',
    inputs: [
...
export const ponsCurveBuyRefundedEventAbi = [
  {
    type: 'event',
